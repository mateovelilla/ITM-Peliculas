 ...
 * @author wong
 */
public class modificarDirector extends javax.swing.JFrame {
    JSONObject _resultado;
    /**
     * Creates new form modificarDirector
     */
    ...
    public void setResultado(JSONObject resultado)
    {
        try{
            ...
            JTextFnac.setText(this._resultado.getString("fechaNacimiento"));
        }catch(Exception e){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("MODIFICAR DIRECTOR");
        ...
        Modificar.setForeground(java.awt.Color.black);
    ...
    private void ModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ModificarActionPerformed
        try{
            ...
            Boolean respuesta = dtor.Modificar(this._resultado.getInt("id"),nombre,nacion,fechaNacimiento);
            if(respuesta)
            {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(modificarDirector.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new modificarDirector().setVisible(true);
            }
        });
    }
